#
#  Be sure to run `pod spec lint SKFontAwesomeIconPickerView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SKFontAwesomeIconPickerView"
  s.version      = "0.0.1"
  s.summary      = "An icon picker view which will show list of icons from Font Awesome."
  ...
  s.description  = <<-DESC
  With the help of this Picker, you can provide a picker for icons from Font awesome.
